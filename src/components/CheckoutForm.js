  ...
  const handleSubmit = async (cart, subtotal, form) => {
    ...
    return(
        <div style={{display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <Button variant="contained" color="secondary" onClick={() => handleSubmit(cart, subtotal, form)} disabled={form.name.length < 2 && form.tel.length < 8 && form.mail.length < 6 && form.mail !== form.mailValid}>Realizar pedido</Button>
